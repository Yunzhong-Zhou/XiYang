...
//                params1.put("type", "ADJUST_MARKET");//ADJUST_SUPERIOR:调整上级; ADJUST_MARKET:调整市场; ADJUST_POST:调整岗位; UPDATE_STORE_USER:修改门店账号;
                RequestCode(params1,"ADJUST_MARKET");//获取验证码
                break;
