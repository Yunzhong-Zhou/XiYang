...
public class MainActivity_m extends BaseActivity {
    private EasyNavigationBar navigationBar;
    private String[] tabText = {"管理", "分派", "审批", "数据", "我的"};
    //未选中icon
    private int[] normalIcon = {R.mipmap.tab1_0_m, R.mipmap.tab2_0_m, R.mipmap.tab3_0_m, R.mipmap.tab4_0, R.mipmap.tab5_0};
    //选中时icon
    private int[] selectIcon = {R.mipmap.tab1_1_m, R.mipmap.tab2_1_m, R.mipmap.tab3_1_m, R.mipmap.tab4_1, R.mipmap.tab5_1};
...
//                .statusBarDarkFont(true, 0.2f) //原理：如果当前设备支持状态栏字体变色，会设置状态栏字体为黑色，如果当前设备不支持状态栏字体变色，会使当前状态栏加上透明度，否则不执行透明度
        ...
        FanPermissionUtils.with(MainActivity_m.this)
                //添加所有你需要申请的权限
...
//                .addPermissions(Manifest.permission.ACCESS_WIFI_STATE)//访问WiFi状态
                ...
                .setForceDeniedPermissionTips("请前往设置->应用->【" + FanPermissionUtils.getAppName(MainActivity_m.this) + "】->权限中打开相关权限，否则功能无法正常运行！")
                //构建配置并生效
                .buildConfig()
                //开始授权
...
//                hideProgress();
                model_up = response;
                if (Integer.valueOf(CommonUtil.getVersionCode(MainActivity_m.this)) < Integer.valueOf(response.getVersion_code())) {
        ...
        textView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Environment.getExternalStorageState().equals(
                    ...
                    final ProgressDialog progressDialog = new ProgressDialog(MainActivity_m.this);    //进度条，在下载的时候实时更新进度，提高用户友好度
...
//        progressDialog.setCanceledOnTouchOutside(false);//点击外部不消失，返回键有用
                    ...
                    //下载APK
                    InstallUtils.with(MainActivity_m.this)
                            //必须-下载地址
...
//                                    .setApkPath(Constants.APK_SAVE_PATH)
                            ...
                            .setCallBack(new InstallUtils.DownloadCallBack() {
                                ...
                                public void onComplete(final String path) {
                                    ...
                                    InstallUtils.checkInstallPermission(MainActivity_m.this, new InstallUtils.InstallPermissionCallBack() {
                                        @Override
                                        public void onGranted() {
                                            ...
                                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                                //先获取是否有安装未知来源应用的权限
                                                boolean haveInstallPermission = MainActivity_m.this.getPackageManager().canRequestPackageInstalls();
                                                if (!haveInstallPermission) {
                                                    //跳转设置开启允许安装
                                                    Uri packageURI = Uri.parse("package:" + MainActivity_m.this.getPackageName());
                                                    Intent intent = new Intent(Settings.ACTION_MANAGE_UNKNOWN_APP_SOURCES, packageURI);
                                                    startActivityForResult(intent, 1000);
                                                    return;
                                                }
                                            }
                                            InstallUtils.installAPK(MainActivity_m.this, path, new InstallUtils.InstallCallBack() {
                                                @Override
                                        ...
                                        public void onDenied() {
                                            //弹出弹框提醒用户
                                            AlertDialog alertDialog = new AlertDialog.Builder(MainActivity_m.this)
                                                    ...
                                                    .setPositiveButton(getString(R.string.update_hint9), new DialogInterface.OnClickListener() {
                                                        ...
                                                        public void onClick(DialogInterface dialog, int which) {
                                                            //打开设置页面
                                                            InstallUtils.openInstallPermissionSetting(MainActivity_m.this, new InstallUtils.InstallPermissionCallBack() {
                                                                @Override
                                                                public void onGranted() {
                                                                    //去安装APK
                                                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
...
//                                                                            Toast.makeText(MainActivity.this, "不允许安装咋搞？强制更新就退出应用程序吧！", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity_m.this, getString(R.string.update_hint1),
