...
public class URLs {
    //测试地址
    public static String IMGHOST = "http://192.168.0.104";//图片地址
    public static String HOST = "http://192.168.0.104";//接口地址
    public static String KFHOST = "http://192.168.0.104";//客服地址
    //正式地址
...
//    public static String KFHOST = "http://chat.leqi.cool";//客服地址
    ...
    //更新
    public static final String Upgrade = HOST +API+ "/api/article/sys-upgrade";
    //引导页
    public static final String Guide = HOST +API+ "/api/app-banner/index";
    //发送验证码
    public static final String Code = HOST +API+ "/api/v1/public/get_auth_code";
    //验证码登录
    public static final String Login1 = HOST +API+ "/api/member/quick-login";
    //登录
    ...
    //热门搜索
    public static final String SearchHot = HOST +API+ "/api/v1/public/hot_list_all";
    //搜索
     ...
     * ********************************我的*****************************************
     */
    public static final String Fragment5 = HOST +API+ "/api/v1/user/get_user_info";
    //银行卡设置
    public static final String Collection = HOST +API+ "/api/member/set-proceeds";
    //修改个人信息
    public static final String ChangeProfile = HOST +API+ "/api/v1/user/user_setup";
    //修改登录密码
    public static final String ChangePassword = HOST +API+ "/api/v1/user/binding_phone";
    //交易密码
    public static final String TransactionPassword = HOST +API+ "/api/v1/techn/techn_pay_pwd";
    //我的收益
    public static final String MyIncome = HOST +API+ "/api/v1/techn/techn_unlock_store";
    //提现
    public static final String TakeCash = HOST +API+ "/api/v1/techn/with_account_increase";
    //提现详情
    public static final String TakeCashDetail = HOST +API+ "/api/v1/techn/user_resume_list";
    //帮助列表
    public static final String Help = HOST +API+ "/api/v1/techn/user_resume_add";
    //在线客服
    public static final String OnlineService = HOST +API+ "/api/v1/techn/user_resume_del";
    //创建留言
    public static final String AddMessage = HOST +API+ "/api/v1/techn/user_resume_modify";
    //关于我们
    public static final String About = HOST +API+ "/api/v1/techn/techn_auth";
    //意见反馈分类
